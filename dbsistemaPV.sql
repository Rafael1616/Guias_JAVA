...
CREATE TABLE IF NOT EXISTS `puntoVenta`.`detalle_ingreso` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `igreso_id` INT NOT NULL,
  `articulo_id` INT NOT NULL,
  `cantidad` INT NOT NULL,
  `precio` DECIMAL(11,2) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_detalleInreso_ingreso_idx` (`igreso_id` ASC) VISIBLE,
  INDEX `fk_detalleIngreso_articulo_idx` (`articulo_id` ASC) VISIBLE,
  CONSTRAINT `fk_detalleInreso_ingreso`
    FOREIGN KEY (`igreso_id`)
...
CREATE TABLE IF NOT EXISTS `puntoVenta`.`detalle_venta` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_detalleVenta_venta_idx` (`articulo_id` ASC) VISIBLE,
  INDEX `fk_detalleVenta_articulo_idx` (`venta_id` ASC) VISIBLE,
